...
const NAME_TEXT = "I'm ELAVARASAN ";
const TITLE_TEXT = 'Software Developer ';
const MULTIPLIER = 1;
        ...
        <div style={styles.wrapper}>
            {nameText !== '' && (
                <div style={styles.container}>
                    <p style={styles.Linkwork}>{nameText}</p>
                </div>
            )}
            {titleText !== '' && (
                <div style={styles.container}>
                    <p > <a style={styles.Linkwork} href="https://elavarasan.me">{titleText}</a></p>
                </div>
            )}
            {timeText !== '' && (
