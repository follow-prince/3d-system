        ...
        >
                ...
                >
                    ...
                    >
                        ...
                        <div style={styles.headerInfo}>
                            <p style={styles.green}>Released: 05/27/2001</p>
                            <p style={styles.green}>Prince (C)2000 Prince Inc.,</p>
                        </div>
                    </div>
                    <div style={styles.body} className="loading-screen-body">
                        <p style={styles.green}>Prince 2000-2024  Linux</p>
                        <div style={styles.spacer} />
                        {showBiosInfo && (
                            <>
                                <p style={styles.green}> </p>
                                <p style={styles.green}>Checking RAM : {14000} OK</p>
                                <div style={styles.spacer} />
                                <div style={styles.spacer} />
                                {showLoadingResources ? (
                                    progress == 1 ? (
                                        <p style={styles.green}>FINISHED LOADING RESOURCES</p>
                                    ) : (
                                        <p style={styles.green} className="loading">
                                            LOADING RESOURCES ({loaded}/
                                            {toLoad === 0 ? '-' : toLoad})
                                        </p>
                                    )
                                ) : (
                                    <p style={styles.green} className="loading">WAIT</p>
                                )}
                            </>
                        )}
                        <div style={styles.spacer} />
                        <div style={styles.resourcesLoadingList}>
                            {resources.map((sourceName) => (
                                <p style={styles.green} key={sourceName}>{sourceName}</p>
                            ))}
                        </div>
                        <div style={styles.spacer} />
                    ...
                    >
                        ...
                        <p style={styles.green}>{getCurrentDate()}</p>
                    </div>
                </div>
            )}
            <div
            ...
            >
                <div style={styles.startPopup}>
                    ...
                    <div style={styles.spacer} />
                    <div style={styles.spacer} /> */}
                    <p style={styles.green}>PRINCE workfolio 🤓</p>
                    {mobileWarning && (
                        <>
                            <br />
                            <b>
                                <p style={styles.warning}>
                                   <span style={{color:'red'}}>WARNING:</span>  This experience is best viewed on
                                </p>
                                <p style={styles.warning}>
                    ...
                    <div style={{ display: 'flex', alignItems: 'flex-end' }}>
                        <p style={styles.green}>Click start to begin{'\xa0'}</p>
                        <span className="blinking-cursor" />
                    </div>
                    <div
                        style={{
                    ...
                    <div style={styles.startPopup}>
                        ...
                        <p>
                            ...
                            <a
                                style={styles.link}
                                href={
                                    'https://github.com/follow-prince'
                                }
                            >
                                bug in firefox
                            </a>
                        ...
                        <div style={styles.spacer} />
                        <p style={styles.green}>Thank you - Prince 😊</p>
                    </div>
                </div>
            )}
            {webGLError && (
                ...
                >
                    <div style={styles.startPopup}>
                        ...
                        <p style={styles.green}>WebGL is required to run this site.</p>
                        <p style={styles.green}>
