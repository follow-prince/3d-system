...
const Contact: React.FC<ContactProps> = (props) => {
    ...
    const handleSubmit = useCallback(() => {
        if (isFormValid) {
            setIsLoading(true);
            fetch('https://elavarasan.me/api/send-email', {
                method: 'POST',
                headers: {
        ...
        <div className="site-page-content">
            <div style={styles.header}>
                ...
                <div style={styles.socials}>
                    <SocialBox
                        icon={ghIcon}
                        link={'https://github.com/follow-prince'}
                    />
                    <SocialBox
                        icon={inIcon}
                        link={'https://www.linkedin.com/in/elavarasa003/'}
                    />
                    <SocialBox
                        icon={twitterIcon}
                        link={'https://twitter.com/elavarasan_me'}
                    />
                </div>
            </div>
            <div className="text-block">
                <p>
                    I am Fresher, however if you have any
